...
int main() {
	...
	json_acc_layer_np::json_pool_str map;
	json_acc_layer_np::json_acc_str root;
	...
	json_acc_layer_np::JSON_Parse_Pool(map, std::move(data));
	...
	json_acc_layer_np::JSON_Serialize_Pool(map, result, 0);
	//std::cout << result;
